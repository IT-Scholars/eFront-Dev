        ...
        <form {$T_PERSONAL_INFO_FORM.attributes}>
            ...
            <!-- Begin -->
<font color="#FF0000" size=3><center><b>IMPORTANT:</b></font> <font size=2>If you have previously participated in training with Kaseya University through IT Scholars, <br><a href="http://community.kaseya.com/kb-legacy/w/wiki/1259.create-a-kaseya-university-learning-center-account.aspx" target=_blank>CLICK HERE</a> to learn how to create and synchronize your accounts between the learning systems.</font></center>
            <!-- End -->
