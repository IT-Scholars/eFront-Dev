...
class module_cert extends EfrontModule {
    ...
    public function getModule() {
		...
		*/
		...
		// echo "\$certGranted[$roleTypeName] is $certGranted[$roleTypeName]";
		if ($certGranted[$roleTypeName]) { 
//			$certURL = "mod/quiz/view-embedded.php?id=10578&username=$username";
			$certURL =  "cert-home.php?username=$username&roleTypeName=$roleTypeName";
		} else {
			$certURL = "KU-poweredby-ITS-ComingSoon.html";
		}
		
		// echo "<br> certURL is $certURL";
