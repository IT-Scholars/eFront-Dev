...
$(document).ready(function(){
	...
	div += '      <td class="center">johndoe-ct</td>';
	...
	div += '      <td class="center">vc11.cis.fiu.edu</td>';
	div += '      <td class="center">37521</td>';
	div += '      <td class="center">johndoe-ct</td>';
	div += '      <td class="center">k4******4l</td>';
	//div += '      <td class="center">'+'********'+'</td>';
	...
	$('#row_2').click(function() { // bind click event to link
		window.open("webRDP.php?tab=tab0&hostName=vc11.cis.fiu.edu&hostPort=37521&username=johndoe-ct&password=k4******4l&domain=FIU&bottomFrameHeightPercentage=97", "_self");
		return false;
    });
	$('#row_3').click(function() { // bind click event to link
    	window.open("webRDP.php?tab=tab1&hostName=vc11.cis.fiu.edu&hostPort=37522&username=johndoe-ct&password=k4******4l&domain=FIU&bottomFrameHeightPercentage=97", "_self");
		return false;
    });
	$('#row_4').click(function() { // bind click event to link
    	window.open("webRDP.php?tab=tab2&hostName=vc11.cis.fiu.edu&hostPort=37523&username=johndoe-ct&password=k4******4l&domain=FIU&bottomFrameHeightPercentage=97" , "_self");
		return false;
    });
	$('#row_5').click(function() { // bind click event to link
    	window.open("webRDP.php?tab=tab3&hostName=vc11.cis.fiu.edu&hostPort=37524&username=johndoe-ct&password=k4******4l&domain=&bottomFrameHeightPercentage=97" , "_self");
		return false;
    });
	$('#row_6').click(function() { // bind click event to link
    	window.open("webRDP.php?tab=tab4&hostName=vc11.cis.fiu.edu&hostPort=37525&username=johndoe-ct&password=k4******4l&domain=&bottomFrameHeightPercentage=97", "_self");
		return false;
    });
	*/
