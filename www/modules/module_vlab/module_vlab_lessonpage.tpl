...
This text and the data below appear from VLab module's getLessonSmartyTpl() and module_vLab_lessonpanel.tpl file
...
{/capture}
{eF_template_printBlock title = $smarty.const._MODULE_VLAB_VLABDATALESSONCPANEL data = $smarty.capture.t_vLab_data_code}