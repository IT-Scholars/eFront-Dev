...
function Efront_Autoload($className) {
	...
	// Added by Masoud Sadjadi on June 30, 2014 to allow a Company field with just one line input
    } else if (strpos($className, "quickform_vlab") !== false) {
        require_once("HTML/QuickForm_vLab.php");
