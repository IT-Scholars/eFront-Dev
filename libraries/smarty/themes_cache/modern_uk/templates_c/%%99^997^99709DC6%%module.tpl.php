<?php /* Smarty version 2.6.27, created on 2014-09-15 16:04:26
         compiled from /var/www/efront/www/modules/module_administrator_tools/module.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'eF_template_printBlock', '/var/www/efront/www/modules/module_administrator_tools/module.tpl', 23, false),array('function', 'eF_template_printForm', '/var/www/efront/www/modules/module_administrator_tools/module.tpl', 27, false),array('function', 'cycle', '/var/www/efront/www/modules/module_administrator_tools/module.tpl', 57, false),array('modifier', 'eF_template_isOptionVisible', '/var/www/efront/www/modules/module_administrator_tools/module.tpl', 222, false),array('modifier', 'cat', '/var/www/efront/www/modules/module_administrator_tools/module.tpl', 311, false),)), $this); ?>
...
, <?php echo $this->_tpl_vars['T_SQL_AFFECTED_ROWS']; ?>
 <?php echo @_MODULE_ADMINISTRATOR_TOOLS_ROWSAFFECTED; ?>
	...
	<?php ob_start(); ?>
		<?php echo smarty_function_eF_template_printForm(array('form' => $this->_tpl_vars['T_FIX_SHARED_FOLDERS_FORM']), $this);?>

	<?php $this->_smarty_vars['capture']['t_fix_shared_folders'] = ob_get_contents(); ob_end_clean(); ?>
...
?>
			<tr class = "defaultRowHeight <?php echo smarty_function_cycle(array('values' => "oddRowColor, evenRowColor"), $this);?>
 <?php if (! $this->_tpl_vars['item']['active']): ?>deactivatedTableElement<?php endif; ?>">
				<td><a class = "editLink <?php if (((is_array($_tmp='tooltip')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>info<?php endif; ?>" url = "ask_information.php?users_LOGIN=<?php echo $this->_tpl_vars['item']['users_login']; ?>
...
<?php ob_start(); ?>
	...
	<?php elseif ($_GET['do'] == 'system'): ?>
		...
		<?php echo smarty_function_eF_template_printBlock(array('tabber' => 'shared_folders','title' => @_MODULE_ADMINISTRATOR_TOOLS_FIXSHAREDFOLDERS,'data' => $this->_smarty_vars['capture']['t_fix_shared_folders'],'image' => '32x32/folders.png'), $this);?>

	<?php elseif ($_GET['do'] == 'enterprise'): ?>
		<?php if (( @G_VERSIONTYPE == 'enterprise' )): ?> 			<?php echo smarty_function_eF_template_printBlock(array('tabber' => 'category_reports','title' => @_MODULE_ADMINISTRATOR_TOOLS_CATEGORYREPORTS,'data' => $this->_smarty_vars['capture']['t_category_reports_code'],'image' => '32x32/categories.png'), $this);?>

			<?php echo smarty_function_eF_template_printBlock(array('tabber' => 'unenroll_courses','title' => @_MODULE_ADMINISTRATOR_TOOLS_UNENROLLJOBCOURSES,'data' => $this->_smarty_vars['capture']['t_unenroll_courses_code'],'image' => '32x32/courses.png'), $this);?>

			<?php echo smarty_function_eF_template_printBlock(array('tabber' => 'job_courses','title' => @_MODULE_ADMINISTRATOR_TOOLS_JOBCOURSES,'data' => $this->_smarty_vars['capture']['t_job_courses_code'],'image' => '32x32/courses.png'), $this);?>

			<?php echo smarty_function_eF_template_printBlock(array('tabber' => 'multiple_placements','title' => @_MODULE_ADMINISTRATOR_TOOLS_MULTIPLEPLACEMENTS,'data' => $this->_smarty_vars['capture']['t_multiple_placements_code'],'image' => '32x32/users.png'), $this);?>
		...
		<?php if (( @G_VERSIONTYPE != 'community' )): ?> 			<?php if (( @G_VERSIONTYPE != 'standard' )): ?> 				<?php echo smarty_function_eF_template_printBlock(array('tabber' => 'user_activity','title' => @_MODULE_ADMINISTRATOR_TOOLS_IDLEUSERS,'data' => $this->_smarty_vars['capture']['t_idle_users_code'],'image' => '32x32/generic.png'), $this);?>
