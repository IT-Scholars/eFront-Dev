<?php /* Smarty version 2.6.27, created on 2014-09-18 05:06:10
         compiled from includes/course_settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'eF_template_printBlock', 'includes/course_settings.tpl', 12, false),array('function', 'eF_template_html_select_date', 'includes/course_settings.tpl', 53, false),array('function', 'html_select_time', 'includes/course_settings.tpl', 53, false),array('modifier', 'sizeof', 'includes/course_settings.tpl', 386, false),array('modifier', 'addSlashes', 'includes/course_settings.tpl', 407, false),array('modifier', 'cat', 'includes/course_settings.tpl', 446, false),array('modifier', 'eF_truncate', 'includes/course_settings.tpl', 453, false),)), $this); ?>
...
#<?php endif; ?>
						<?php echo smarty_function_eF_template_html_select_date(array('prefix' => 'completion_','time' => $this->_tpl_vars['T_TO_TIMESTAMP'],'start_year' => "-5",'end_year' => "+5",'field_order' => $this->_tpl_vars['T_DATE_FORMATGENERAL']), $this);?>
 <?php echo @_TIME; ?>
...
<?php endif; ?></a>
			...
			<?php if (@G_VERSIONTYPE != 'community'): ?> 				<span>
					<img src = "images/16x16/certificate.png" title = "<?php echo @_FORMATCERTIFICATE; ?>
" alt = "<?php echo @_FORMATCERTIFICATE; ?>
"/>
					<a href = "<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=format_certificate" ><?php echo @_FORMATCERTIFICATE; ?>
</a>
				</span>
				<span id = "auto_certificates" <?php if (! $this->_tpl_vars['T_CURRENT_COURSE']->options['auto_complete']): ?>style = "display:none"<?php endif; ?>>
					<img src = "images/16x16/certificate.png" title = "<?php echo @_AUTOCERTIFICATES; ?>
" alt = "<?php echo @_AUTOCERTIFICATES; ?>
"/>
					<a href = "javascript:void(0)" <?php if (! $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change'): ?> onclick = "setAutoCertificate(this)" <?php endif; ?>><?php echo @_AUTOMATICCERTIFICATES; ?>
: <?php if ($this->_tpl_vars['T_CURRENT_COURSE']->options['auto_certificate']): ?><?php echo @_YES; ?>
<?php else: ?><?php echo @_NO; ?>
<?php endif; ?></a>
				</span>
				<span id = "certificate_all">
					<img src = "images/16x16/certificate.png" title = "<?php echo @_ISSUECERTIFICATEFORCOMPLTETED; ?>
" alt = "<?php echo @_ISSUECERTIFICATEFORCOMPLTETED; ?>
"/>
					<a href = "javascript:void(0)" <?php if (! $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change'): ?> onclick = "issueCertificateAll(this)" <?php endif; ?>><?php echo @_ISSUECERTIFICATEFORCOMPLTETED; ?>
</a>
				</span>
				<span id = "certificate_date">
					<img src = "images/16x16/certificate.png" title = "<?php echo @_SETCERTIFICATEDATEFORCOMPLTETED; ?>
" alt = "<?php echo @_SETCERTIFICATEDATEFORCOMPLTETED; ?>
"/>
					<a href = "javascript:void(0)" <?php if (! $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change'): ?> onclick = "setCertificateDate(this)" <?php endif; ?>><?php echo @_SETCERTIFICATEDATEFORCOMPLTETED; ?>
</a>
				</span>
				<span id = "revole_expired">
					<img src = "images/16x16/certificate.png" title = "<?php echo @_REVOKECERTIFICATEFOREXPIRED; ?>
" alt = "<?php echo @_REVOKECERTIFICATEFOREXPIRED; ?>
"/>
					<a href = "javascript:void(0)" <?php if (! $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change'): ?> onclick = "revokeExpiredCertificates(this)" <?php endif; ?>><?php echo @_REVOKECERTIFICATEFOREXPIRED; ?>
</a>
				</span>
			<?php endif; ?> 				<span>
...
"/>
				...
				<span>
					<img src = "images/16x16/success.png" title = "<?php echo @_SETSHOWNUSERSSTATUSCOMPLETED; ?>
" alt = "<?php echo @_SETSHOWNUSERSSTATUSCOMPLETED; ?>
"/>
					<a href = "javascript:void(0)" <?php if (! $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change'): ?> onclick = "setShownUsersStatusCompleted(this)" <?php endif; ?>><?php echo @_SETSHOWNUSERSSTATUSCOMPLETED; ?>
</a>
				</span>
				<span>
					<img src = "images/16x16/refresh.png" title = "<?php echo @_RESETALLUSERS; ?>
" alt = "<?php echo @_RESETALLUSERS; ?>
"/>
					<a href = "javascript:void(0)" <?php if (! $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change'): ?> onclick = "if (confirm('<?php echo @_IRREVERSIBLEACTIONAREYOUSURE; ?>
')) resetAllUsers(this)" <?php endif; ?>><?php echo @_RESETALLUSERS; ?>
</a>
				</span>
			</div>
...
<?php elseif ($this->_tpl_vars['T_OP'] == 'format_certificate'): ?>
	<?php if (@G_VERSIONTYPE != 'community'): ?> 				<?php ob_start(); ?>
					<div class = "headerTools">
						<span>
							<img src="images/16x16/add.png" title="<?php echo @_ADDCERTIFICATETEMPLATEXML; ?>
" alt="<?php echo @_ADDCERTIFICATETEMPLATEXML; ?>
"/>&nbsp;<a href="<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=add_certificate_template&popup=1" onclick="eF_js_showDivPopup(event, '<?php echo @_ADDCERTIFICATETEMPLATEXML; ?>
', 3)" target="POPUP_FRAME"><?php echo @_ADDCERTIFICATETEMPLATEXML; ?>
</a>&nbsp;
						</span>
						<span>
							&nbsp;<img src="images/16x16/go_into.png" title="<?php echo @_FORMATCERTIFICATELIVEDOCXMETHOD; ?>
" alt="<?php echo @_FORMATCERTIFICATELIVEDOCXMETHOD; ?>
"/>&nbsp;<a href="<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=format_certificate_docx"><?php echo @_FORMATCERTIFICATELIVEDOCXMETHOD; ?>
</a>
						</span>
					</div>

					<fieldset class="fieldsetSeparator">
					<legend><?php echo @_FORMATCERTIFICATETEMPLATE; ?>
</legend>

					<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['javascript']; ?>

					<form <?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['attributes']; ?>
>
						<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['hidden']; ?>

						<table class="formElements" style="width:100%;">
							<tr>
								<td class="labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['existing_certificate']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['existing_certificate']['html']; ?>
&nbsp;</td>
							</tr>
							<tr height="7px"></tr>
							<tr>
								<td class="labelCell"><?php echo @_CERTIFICATEOPERATIONS; ?>
:&nbsp;</td>
								<td>
									<a href="javascript:void(0);" onclick="location='<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=course_certificates&export=xml&preview=1&certificate_tpl='+$('select_certificate').value"><?php echo @_PREVIEW; ?>
</a>&nbsp;<div style="display: inline;border-right: 1px solid #333333;"></div>
									<a href="javascript:void(0);" id="edit_certificate_template_href" onclick="setCertificateOperationsHref('<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=edit_certificate_template&popup=1&template_id='); eF_js_showDivPopup(event, '<?php echo @_EDITCERTIFICATETEMPLATEXML; ?>
', 3)" target="POPUP_FRAME" <?php if ($this->_tpl_vars['T_CURRENT_TEMPLATE_TYPE'] == 'main'): ?>style="display:none;"<?php endif; ?>><?php echo @_EDIT; ?>
</a><div <?php if ($this->_tpl_vars['T_CURRENT_TEMPLATE_TYPE'] == 'main'): ?>style="display:none; border-right: 1px solid #333333;"<?php else: ?>style="display: inline; border-right: 1px solid #333333;"<?php endif; ?> id="edit_certificate_template_separator">&nbsp;</div>
									<a href="javascript:void(0);" id="rename_certificate_template_href" onclick="setCertificateOperationsHref('<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=rename_certificate_template&popup=1&template_id='); eF_js_showDivPopup(event, '<?php echo @_RENAMECERTIFICATETEMPLATEXML; ?>
', 0)" target="POPUP_FRAME" <?php if ($this->_tpl_vars['T_CURRENT_TEMPLATE_TYPE'] == 'main'): ?>style="display:none;"<?php endif; ?>><?php echo @_RENAME; ?>
</a><div <?php if ($this->_tpl_vars['T_CURRENT_TEMPLATE_TYPE'] == 'main'): ?>style="display:none; border-right: 1px solid #333333;"<?php else: ?>style="display: inline; border-right: 1px solid #333333;"<?php endif; ?> id="rename_certificate_template_separator">&nbsp;</div>
									<a href="javascript:void(0);" id="clone_certificate_template_href" onclick="setCertificateOperationsHref('<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=clone_certificate_template&popup=1&template_id='); eF_js_showDivPopup(event, '<?php echo @_CLONECERTIFICATETEMPLATEXML; ?>
', 0)" target="POPUP_FRAME"><?php echo @_CLONE; ?>
</a><div <?php if ($this->_tpl_vars['T_CURRENT_TEMPLATE_TYPE'] == 'main'): ?>style="display:none; border-right: 1px solid #333333;"<?php else: ?>style="display: inline; border-right: 1px solid #333333;"<?php endif; ?> id="clone_certificate_template_separator">&nbsp;</div>
									<a href="javascript:void(0);" id="delete_certificate_template_href" onclick="setCertificateOperationsHref('<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=delete_certificate_template&popup=1&template_id='); return confirm('<?php echo @_IRREVERSIBLEACTIONAREYOUSURE; ?>
')" <?php if ($this->_tpl_vars['T_CURRENT_TEMPLATE_TYPE'] == 'main'): ?>style="display:none;"<?php endif; ?>><?php echo @_DELETE; ?>
</a>
								</td>
							</tr>
						<?php if (@G_VERSIONTYPE != 'standard'): ?> 	
							<tr>
								<td class="labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['custom1']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['custom1']['html']; ?>
&nbsp;</td>
							</tr>
							<tr>
								<td class="labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['custom2']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['custom2']['html']; ?>
&nbsp;</td>
							</tr>
							<tr>
								<td class="labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['custom3']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['custom3']['html']; ?>
&nbsp;</td>
							</tr>
						<?php endif; ?> 	
						</table>
					</fieldset>
					<?php if (@G_VERSIONTYPE != 'standard'): ?> 						<fieldset class="fieldsetSeparator" style="margin-top: 5px;">
						<legend><?php echo @_SETCERTIFICATEEXPIRATION; ?>
</legend>
					<?php endif; ?> 						<table class="formElements" style="width:100%;">
							<?php if (@G_VERSIONTYPE != 'standard'): ?> 							<tr>
								<td class="labelCell"><?php echo @_DURATIONFOREXPIRATION; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['months']['html']; ?>
&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['months']['label']; ?>
,&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['days']['html']; ?>
&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['days']['label']; ?>
</td>
							</tr>
							<tr>
								<td></td>
								<td class="infoCell" style="white-space:normal;" colspan="2"><?php echo @_EXPIREINSTRUCTIONS; ?>
</td>
							</tr>
							<tr id="resetRow" style="display:none;">
								<td class="labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['reset']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['reset']['html']; ?>
&nbsp;<?php echo @_ORRESETCOURSEBEFOREEXPIRE; ?>
:&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['months_reset']['html']; ?>
&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['months_reset']['label']; ?>
,&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['days_reset']['html']; ?>
&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['days_reset']['label']; ?>
</td>
							</tr>

							<?php endif; ?> 							<tr height="7px"></tr>
							<tr>
								<td></td>
								<td colspan="2"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['submit_certificate']['html']; ?>
</td>
							</tr>
						</table>
					<?php if (@G_VERSIONTYPE != 'standard'): ?> 						</fieldset>
					<?php endif; ?> 					</form>
				<?php $this->_smarty_vars['capture']['t_certificate_code'] = ob_get_contents(); ob_end_clean(); ?>
				<?php echo smarty_function_eF_template_printBlock(array('title' => @_FORMATCERTIFICATE,'data' => $this->_smarty_vars['capture']['t_certificate_code'],'image' => '32x32/certificate.png','main_options' => $this->_tpl_vars['T_TABLE_OPTIONS'],'options' => $this->_tpl_vars['T_COURSE_OPTIONS'],'help' => 'Course_actions'), $this);?>

	<?php endif; ?> <?php elseif ($this->_tpl_vars['T_OP'] == 'format_certificate_docx'): ?>
	<?php if (@G_VERSIONTYPE != 'community'): ?> 				<?php ob_start(); ?>
					<div class = "headerTools">
						<span>
							<img src="images/16x16/go_into.png" title="<?php echo @_FORMATCERTIFICATEFPDFMETHOD; ?>
" alt="<?php echo @_FORMATCERTIFICATEFPDFMETHOD; ?>
"/>&nbsp;<a href="<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['T_BASE_URL']; ?>
&op=format_certificate&switch=1"><?php echo @_FORMATCERTIFICATEFPDFMETHOD; ?>
</a>
						</span>
					</div>
...
>
						...
						<table class = "formElements" style = "width:100%">
							<tr><td class = "labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['file_upload']['label']; ?>
:&nbsp;</td>
								<td class = "elementCell" colspan="3"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['file_upload']['html']; ?>
</td></tr>
							<tr><td class = "labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['existing_certificate']['label']; ?>
:&nbsp;</td>
								<td class = "elementCell" colspan="1"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['existing_certificate']['html']; ?>
&nbsp;</td>
							</tr>
							<tr><td colspan = "1"></td><td class = "infoCell" style = "white-space:normal;" colspan = "3">
								<?php echo @_CERTIFICATEINSTRUCTIONS; ?>
		...
		<?php if (@G_VERSIONTYPE != 'standard'): ?> 					<fieldset class="fieldsetSeparator" style="margin-top: 0px;">
					<legend><?php echo @_SETCERTIFICATEEXPIRATION; ?>
</legend>
		<?php endif; ?> 						<table class="formElements" style="width:100%;">
		<?php if (@G_VERSIONTYPE != 'standard'): ?> 							<tr><td class = "labelCell"><?php echo @_DURATIONFOREXPIRATION; ?>
:&nbsp;</td>
								<td class = "elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['months']['html']; ?>
 <?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['months']['label']; ?>
, <?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['days']['html']; ?>
 <?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['days']['label']; ?>
							...
							<tr><td colspan = "1"></td><td class = "infoCell" style = "white-space:normal;" colspan = "3">
								<?php echo @_EXPIREINSTRUCTIONS; ?>

								</td>
							</tr>
							<tr id="resetRow" style="display:none"><td class = "labelCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['reset']['label']; ?>
:&nbsp;</td>
								<td class = "elementCell"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['reset']['html']; ?>
&nbsp;<?php echo @_ORRESETCOURSEBEFOREEXPIRE; ?>
:&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['months_reset']['html']; ?>
...
&nbsp;<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['days_reset']['label']; ?>
		...
		<?php endif; ?> 							<tr><td></td>
								<td colspan="3"><?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['preview']['html']; ?>
 &nbsp;
												<?php echo $this->_tpl_vars['T_CERTIFICATE_FORM']['submit_certificate']['html']; ?>
	...
	<?php endif; ?> <?php elseif ($this->_tpl_vars['T_OP'] == 'add_certificate_template' || $this->_tpl_vars['T_OP'] == 'edit_certificate_template'): ?>
	<?php if (@G_VERSIONTYPE != 'community'): ?> 				<?php ob_start(); ?>
					<?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['javascript']; ?>

					<form <?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['attributes']; ?>
>
						<?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['hidden']; ?>

						<table class="formElements" style="width:100%;">
							<tr>
								<td class="labelCell"><?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['certificate_name']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['certificate_name']['html']; ?>
&nbsp;</td>
							</tr>
							<tr height="7px"></tr>
							<tr>
								<td class="elementCell" colspan="2"><?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['certificate_xml']['html']; ?>
</td>
							</tr>
							<tr height="7px"></tr>
							<tr>
								<td class="infoCell" style="white-space:normal;" colspan="2"><?php echo @_CERTIFICATEINSTRUCTIONSXML; ?>
</td>
							</tr>
							<tr height="7px"></tr>
							<tr>
								<td colspan="2"><?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['preview_certificate_template']['html']; ?>
&nbsp;<?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_FORM']['submit_certificate_template']['html']; ?>
</td>
							</tr>
						</table>
					</form>
				<?php $this->_smarty_vars['capture']['t_add_certificate_template_code'] = ob_get_contents(); ob_end_clean(); ?>
<?php if ($this->_tpl_vars['T_OP'] == 'add_certificate_template'): ?>
				<?php echo smarty_function_eF_template_printBlock(array('title' => @_ADDCERTIFICATETEMPLATEXML,'data' => $this->_smarty_vars['capture']['t_add_certificate_template_code'],'image' => '32x32/certificate.png','help' => 'Course_actions'), $this);?>

<?php elseif ($this->_tpl_vars['T_OP'] == 'edit_certificate_template'): ?>
				<?php echo smarty_function_eF_template_printBlock(array('title' => @_EDITCERTIFICATETEMPLATEXML,'data' => $this->_smarty_vars['capture']['t_add_certificate_template_code'],'image' => '32x32/certificate.png','help' => 'Course_actions'), $this);?>

<?php endif; ?>
	<?php if ($this->_tpl_vars['T_MESSAGE'] && $this->_tpl_vars['T_MESSAGE_TYPE'] == 'success'): ?>
	<script>
		re = /\?/;
		!re.test(parent.location) ? parent.location = parent.location+'<?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_REDIRECT']; ?>
' : parent.location = parent.location+'<?php echo $this->_tpl_vars['T_ADD_CERTIFICATE_TEMPLATE_REDIRECT']; ?>
';
	</script>
	<?php endif; ?>

	<?php endif; ?> <?php elseif ($this->_tpl_vars['T_OP'] == 'rename_certificate_template'): ?>
	<?php if (@G_VERSIONTYPE != 'community'): ?> 				<?php ob_start(); ?>
					<?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_FORM']['javascript']; ?>

					<form <?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_FORM']['attributes']; ?>
>
						<?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_FORM']['hidden']; ?>

						<table class="formElements" style="margin-left:50px;">
							<tr>
								<td class="labelCell"><?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_FORM']['certificate_name']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_FORM']['certificate_name']['html']; ?>
&nbsp;</td>
							</tr>
							<tr height="7px"></tr>
							<tr>
								<td></td>
								<td colspan="2"><?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_FORM']['rename_certificate_template']['html']; ?>
</td>
							</tr>
						</table>
					</form>
				<?php $this->_smarty_vars['capture']['t_rename_certificate_template_code'] = ob_get_contents(); ob_end_clean(); ?>
				<?php echo smarty_function_eF_template_printBlock(array('title' => @_RENAMECERTIFICATETEMPLATEXML,'data' => $this->_smarty_vars['capture']['t_rename_certificate_template_code'],'image' => '32x32/certificate.png','help' => 'Course_actions'), $this);?>

	<?php if ($this->_tpl_vars['T_MESSAGE'] && $this->_tpl_vars['T_MESSAGE_TYPE']): ?>
	<script>
		re = /\?/;
		!re.test(parent.location) ? parent.location = parent.location+'<?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_REDIRECT']; ?>
' : parent.location = parent.location+'<?php echo $this->_tpl_vars['T_RENAME_CERTIFICATE_TEMPLATE_REDIRECT']; ?>
';
	</script>
	<?php endif; ?>

	<?php endif; ?> <?php elseif ($this->_tpl_vars['T_OP'] == 'clone_certificate_template'): ?>
	<?php if (@G_VERSIONTYPE != 'community'): ?> 				<?php ob_start(); ?>
					<?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_FORM']['javascript']; ?>

					<form <?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_FORM']['attributes']; ?>
>
						<?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_FORM']['hidden']; ?>

						<table class="formElements" style="margin-left:50px;">
							<tr>
								<td class="labelCell"><?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_FORM']['certificate_name']['label']; ?>
:&nbsp;</td>
								<td class="elementCell"><?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_FORM']['certificate_name']['html']; ?>
&nbsp;</td>
							</tr>
							<tr height="7px"></tr>
							<tr>
								<td></td>
								<td colspan="2"><?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_FORM']['clone_certificate_template']['html']; ?>
</td>
							</tr>
						</table>
					</form>
				<?php $this->_smarty_vars['capture']['t_clone_certificate_template_code'] = ob_get_contents(); ob_end_clean(); ?>
				<?php echo smarty_function_eF_template_printBlock(array('title' => @_CLONECERTIFICATETEMPLATEXML,'data' => $this->_smarty_vars['capture']['t_clone_certificate_template_code'],'image' => '32x32/certificate.png','help' => 'Course_actions'), $this);?>

	<?php if ($this->_tpl_vars['T_MESSAGE'] && $this->_tpl_vars['T_MESSAGE_TYPE']): ?>
	<script>
		re = /\?/;
		!re.test(parent.location) ? parent.location = parent.location+'<?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_REDIRECT']; ?>
' : parent.location = parent.location+'<?php echo $this->_tpl_vars['T_CLONE_CERTIFICATE_TEMPLATE_REDIRECT']; ?>
';
	</script>
	<?php endif; ?>

	<?php endif; ?> <?php elseif ($this->_tpl_vars['T_OP'] == 'course_rules'): ?>
...
<?php if (( @G_VERSIONTYPE != 'community' )): ?> 	<?php if (( @G_VERSIONTYPE != 'standard' )): ?> 					<script>translations['_COURSEDOESNOTEXIST'] = '<?php echo @_COURSEDOESNOTEXIST; ?>
';</script>					
					<fieldset class = "fieldsetSeparator">
						<legend><?php echo @_RULESBETWEENCOURSES; ?>
</legend>
						<table class = "statisticsSelectList">
							<tr><td class = "labelCell"><?php echo @_COURSEDEPENDSON; ?>
:</td>
								<td class = "elementCell">
									<input type = "text" id = "autocomplete" class = "autoCompleteTextBox" value = "<?php echo $this->_tpl_vars['T_DEPENDSON_COURSE']; ?>
" onclick = "this.value='';$('autocomplete_course_hidden').value='';"/>
...
"/>
									...
									<input type = "hidden" id = "autocomplete_course_hidden" value = "<?php echo $this->_tpl_vars['T_CURRENT_COURSE']->course['depends_on']; ?>
"/>
								</td>
							</tr>
							<tr><td></td>
						...
						<?php if (! $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change'): ?>	
							<tr><td></td>
								<td class = "submitCell"><input type = "submit" value = "<?php echo @_SUBMIT; ?>
" class = "flatButton" onclick = "setInterCourseRules(this);"/></td>
							</tr>
						<?php endif; ?>
						</table>
					</fieldset>					
...
';
				var switchcalendarmode = '<?php echo @_SWITCHCALENDARMODE; ?>
';
				var switchperiodmode = '<?php echo @_SWITCHPERIODMODE; ?>
';
		</script>
...
&popup=1" onclick = "eF_js_showDivPopup(event, '<?php echo @_ADDCALENDAR; ?>
...
&nbsp;</td><td><?php echo smarty_function_eF_template_html_select_date(array('prefix' => 'from_','time' => $this->_tpl_vars['start_date'],'start_year' => "-5",'end_year' => "+5",'field_order' => $this->_tpl_vars['T_DATE_FORMATGENERAL']), $this);?>
 <?php echo @_TIME; ?>
: <?php echo smarty_function_html_select_time(array('prefix' => 'from_','time' => $this->_tpl_vars['start_date'],'display_seconds' => false), $this);?>
&nbsp;</td></tr>
							<tr><td><?php echo @_TO; ?>
&nbsp;</td><td><?php echo smarty_function_eF_template_html_select_date(array('prefix' => 'to_','time' => $this->_tpl_vars['end_date'],'start_year' => "-5",'end_year' => "+5",'field_order' => $this->_tpl_vars['T_DATE_FORMATGENERAL']), $this);?>
 <?php echo @_TIME; ?>
...
" class = "handle" onclick = "showEdit(0)"/>
							<img src = "images/16x16/error_delete.png" id = "remove_schedule_link_0" alt = "<?php echo @_DELETESCHEDULE; ?>
...
#
						...
						<?php elseif ($this->_tpl_vars['lesson']['start_period']): ?>
							<span><?php echo @_FROM; ?>
&nbsp;<?php echo $this->_tpl_vars['lesson']['start_period']; ?>
&nbsp;<?php echo @_DAYSAFTERCOURSEENROLLMENT; ?>
&nbsp;<?php echo @_AND; ?>
&nbsp;<?php echo @_FOR; ?>
&nbsp;<?php echo $this->_tpl_vars['lesson']['end_period']; ?>
&nbsp;<?php echo @_DAYSCONDITIONALLOWERCASE; ?>
</span>
						<?php else: ?>
							<span class = "emptyCategory"><?php echo @_NOSCHEDULESET; ?>
</span>
...
&nbsp;</td></tr>
						...
						<table id = "deadline_dates_form_<?php echo $this->_tpl_vars['id']; ?>
" style = "display:none">
							<tr><td><?php echo @_FROM; ?>
&nbsp;
							
								<select name="start_period" id = "start_period_<?php echo $this->_tpl_vars['id']; ?>
">
										<?php $_from = $this->_tpl_vars['T_DAYS_AFTER_ENROLLMENT']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['roles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['roles_list']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
        $this->_foreach['roles_list']['iteration']++;
?>
														<option value="<?php echo $this->_tpl_vars['key']; ?>
" <?php if (( $this->_tpl_vars['lesson']['start_period'] == $this->_tpl_vars['key'] )): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
</option>
											<?php endforeach; endif; unset($_from); ?>
								</select><?php echo @_DAYSAFTERCOURSEENROLLMENT; ?>
</td>
							<td>&nbsp;<?php echo @_AND; ?>
&nbsp;<?php echo @_FOR; ?>
&nbsp;
							
							<select name="stop_period" id = "stop_period_<?php echo $this->_tpl_vars['id']; ?>
">
										<?php $_from = $this->_tpl_vars['T_DAYS_AFTER_ENROLLMENT']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['roles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['roles_list']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
...
?>
														<option value="<?php echo $this->_tpl_vars['key']; ?>
" <?php if (( $this->_tpl_vars['lesson']['end_period'] == $this->_tpl_vars['key'] )): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
</option>
											<?php endforeach; endif; unset($_from); ?>
								</select>&nbsp;<?php echo @_DAYS; ?>
</td></tr>
						</table>
...
">
							<img src = "images/16x16/<?php if ($this->_tpl_vars['lesson']['start_date'] || $this->_tpl_vars['lesson']['start_period']): ?>edit.png<?php else: ?>add.png<?php endif; ?>" alt = "<?php echo @_ADDSCHEDULE; ?>
" title = "<?php echo @_ADDSCHEDULE; ?>
...
)" <?php if (! $this->_tpl_vars['lesson']['start_date'] && ! $this->_tpl_vars['lesson']['start_period']): ?>style = "display:none"<?php endif; ?>/>
						</span>&nbsp;
...
" style = "display:none" onclick = "setSchedule(this, <?php echo $this->_tpl_vars['id']; ?>
						...
						<img id = "period_submit_<?php echo $this->_tpl_vars['id']; ?>
" style="display:none" src = "images/16x16/success.png" alt = "<?php echo @_SAVE; ?>
" title = "<?php echo @_SAVE; ?>
" class = "ajaxHandle"  style = "display:none" onclick = "setPeriod(this, <?php echo $this->_tpl_vars['id']; ?>
)"/>
...
" style = "display:none" onclick = "hideEdit(<?php echo $this->_tpl_vars['id']; ?>
						...
						<img src = "images/16x16/calendar.png" alt = "<?php echo @_SWITCHCALENDARMODE; ?>
" title = "<?php echo @_SWITCHCALENDARMODE; ?>
" class = "ajaxHandle" style = "display:none" id="toggle_way_<?php echo $this->_tpl_vars['id']; ?>
"  onclick = "switchWay(<?php echo $this->_tpl_vars['id']; ?>
)"/>&nbsp;
