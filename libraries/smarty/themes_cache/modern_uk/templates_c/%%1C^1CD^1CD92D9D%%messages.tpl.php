<?php /* Smarty version 2.6.27, created on 2014-09-15 14:00:24
         compiled from includes/messages.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'includes/messages.tpl', 17, false),array('modifier', 'implode', 'includes/messages.tpl', 194, false),array('modifier', 'sizeof', 'includes/messages.tpl', 201, false),array('modifier', 'eF_template_isOptionVisible', 'includes/messages.tpl', 228, false),array('modifier', 'eF_truncate', 'includes/messages.tpl', 304, false),array('function', 'math', 'includes/messages.tpl', 22, false),array('function', 'eF_template_printBlock', 'includes/messages.tpl', 51, false),array('function', 'cycle', 'includes/messages.tpl', 286, false),)), $this); ?>
...
&popup=1" onclick = "eF_js_showDivPopup(event, '<?php echo @_EDIT; ?>
...
';
        		var enterprise = 0;
        		<?php if (@G_VERSIONTYPE == 'enterprise'): ?>         			var enterprise = 1;
        		<?php endif; ?>         	</script>
...
. <?php echo @_SEPARATEMULTIPLEUSERS; ?>
            ...
            <div id = "additional_recipients_categories" style="display:none;">
                <div>
                    <table>
                    <?php if (@G_VERSIONTYPE == 'enterprise'): ?>                                                 <tr style = "display:none;"><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['only_specific_users']['html']; ?>
   ...
   </td><td colspan=2 align="left"><?php echo @_ALLACTIVESYSTEMUSERS; ?>
</td></tr>
                        <tr <?php if ($_SESSION['s_type'] == 'administrator'): ?>style="display:none;"<?php endif; ?>><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['to_supervisors']['html']; ?>
   </td><td colspan=2 align="left"><?php echo @_TOYOURSUPERVISORS; ?>
</td></tr>
                        <tr <?php if ($_SESSION['s_type'] == 'administrator'): ?>style="display:none;"<?php endif; ?>><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['to_branch_supervisors']['html']; ?>
   </td><td colspan=2 align="left"><?php echo @_TOBRANCHSUPERVISORS; ?>
</td></tr>
...
:&nbsp;</td><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['professor']['html']; ?>
                        ...
                        <tr <?php if (! $this->_tpl_vars['T_BRANCHES']): ?>style = "display:none"<?php endif; ?>><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['specific_branch_job_description']['html']; ?>
</td><td width="27%"><?php echo @_EMPLOYEESOFBRANCH; ?>
:&nbsp;</td><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['branch_recipients']['html']; ?>
</td><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['include_subbranches']['html']; ?>
</td><td id="include_subbranches_label" style="visibility:hidden;white-space:nowrap;">(<?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['include_subbranches']['label']; ?>
)</td></tr>
                                                <tr <?php if (! $this->_tpl_vars['T_FULL_ACCESS']): ?>style = "display:none"<?php endif; ?>><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['specific_job_description']['html']; ?>
  </td><td><?php echo @_WITHJOBDESCRIPTION; ?>
:&nbsp;</td><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['job_description_recipients']['html']; ?>
</td></tr>
                        <tr <?php if (! $this->_tpl_vars['T_FULL_ACCESS']): ?>style = "display:none"<?php endif; ?>><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['specific_skill']['html']; ?>
  </td><td><?php echo @_EMPLOYEESWITHSKILL; ?>
:&nbsp;</td><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['skill_recipients']['html']; ?>
</td></tr>

                                                <tr style = "display:none"><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['specific_group']['html']; ?>
  </td><td><?php echo @_EMPLOYEESINGROUP; ?>
:&nbsp;</td><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['group_recipients']['html']; ?>
</td></tr>

                    <?php else: ?>                                                   <tr style="display:none;"><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['only_specific_users']['html']; ?>
   </td><td><?php echo @_ONLYRECIPIENTSDEFINEDBELOW; ?>
</td></tr>
                         <tr <?php if ($_SESSION['s_type'] != 'administrator'): ?>style="display:none;"<?php endif; ?>><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['recipients']['active_users']['html']; ?>
...
:&nbsp;</td><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['group_recipients']['html']; ?>
                    ...
                    <?php endif; ?>                     	<tr><td colspan = "100%"><hr></td></tr>
                                                  <tr <?php if (! $this->_tpl_vars['T_FULL_ACCESS']): ?>style = "display:none"<?php endif; ?>><td><?php echo $this->_tpl_vars['T_ADD_MESSAGE_FORM']['specific_type']['html']; ?>
...
" /></a>
				...
				<?php if ($this->_tpl_vars['_change_']): ?>
					<?php if ($_SESSION['s_type'] != 'student' || ((is_array($_tmp='messages')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
						<a href = "<?php echo $_SERVER['PHP_SELF']; ?>
