<?php /* Smarty version 2.6.27, created on 2014-09-29 16:34:26
         compiled from includes/maintenance.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'eF_truncate', 'includes/maintenance.tpl', 34, false),array('modifier', 'replace', 'includes/maintenance.tpl', 142, false),array('function', 'eF_template_printBlock', 'includes/maintenance.tpl', 58, false),array('function', 'eF_template_html_select_date', 'includes/maintenance.tpl', 90, false),array('function', 'cycle', 'includes/maintenance.tpl', 274, false),)), $this); ?>
<?php ob_start(); ?>
	<tr><td class = "moduleCell">

	<?php ob_start(); ?>
	    <table>
	    <?php if ($_GET['check_cleanup']): ?>
...
"    alt = "<?php echo @_INFO; ?>
"    onclick = "eF_js_showDivPopup(event, '<?php echo @_ORPHANUSERFOLDERSCHECK; ?>
...
"/>&nbsp;
	                <img src = "images/16x16/help.png"      title = "<?php echo @_INFO; ?>
"         alt = "<?php echo @_INFO; ?>
"         onclick = "eF_js_showDivPopup(event, '<?php echo @_USERSWITHOUTFOLDERSCHECK; ?>
...
"/>&nbsp;
	                <img src = "images/16x16/help.png"   title = "<?php echo @_INFO; ?>
"    alt = "<?php echo @_INFO; ?>
"    onclick = "eF_js_showDivPopup(event, '<?php echo @_ORPHANLESSONFOLDERSCHECK; ?>
...
"/>&nbsp;
	                <img src = "images/16x16/help.png"      title = "<?php echo @_INFO; ?>
"         alt = "<?php echo @_INFO; ?>
"         onclick = "eF_js_showDivPopup(event, '<?php echo @_LESSONSWITHOUTFOLDERSCHECK; ?>
...
?ctg=maintenance&tab=tasks&check_cleanup=1'"></td></tr>
	    </table>
...
">
		...
		<?php if ($this->_tpl_vars['T_CACHE_PANEL']): ?>
		<div class = "tabbertab <?php if ($_GET['tab'] == 'apc'): ?>tabbertabdefault<?php endif; ?>" title = "Cache">
			<iframe <?php if ($this->_tpl_vars['T_CACHE_PANEL'] == 'apcu'): ?>src = "apcu.php"<?php elseif ($this->_tpl_vars['T_CACHE_PANEL'] == 'apc'): ?>src = "apc.php"<?php elseif ($this->_tpl_vars['T_CACHE_PANEL'] == 'wincache'): ?>src = "wincache.php"<?php endif; ?> width = "100%" height = "800px" frameborder="no"></iframe>
		</div>
		<?php endif; ?>
...
&nbsp;<?php echo $this->_tpl_vars['T_LOCKDOWN_FORM']['submit_message']['html']; ?>
</td></tr>
				        <?php endif; ?>
			        </table>
		        </form>
...
" onclick = "deleteTokens(this)"/></td></tr>
			<?php if (( @G_VERSIONTYPE != 'community' )): ?> 				<?php if (@G_VERSIONTYPE != 'standard'): ?> 		    <tr><td class = "labelCell"><?php echo @_CLICKHERETOREDELETEADVANCEDREPORTVIEWS; ?>
:&nbsp;</td>
    		    <td class = "submitCell"><input type = "button" class = "flatButton" value = "<?php echo @_DELETE; ?>
" onclick = "deleteViews(this)"/></td></tr>
				<?php endif; ?> 			<?php endif; ?> 		    <tr><td class = "labelCell">Archive old data:&nbsp;</td>
    		    <td class = "submitCell"><input type = "button" class = "flatButton" value = "<?php echo @_ARCHIVE; ?>
" onclick = "archiveTables(this)"/></td></tr>
		</table>
