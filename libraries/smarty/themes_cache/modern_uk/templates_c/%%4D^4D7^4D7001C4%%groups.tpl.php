<?php /* Smarty version 2.6.27, created on 2014-09-15 16:54:57
...
&">
			<tr class = "topTitle">
				<td name = "name" class = "topTitle"><?php echo @_LESSONNAME; ?>
</td>
				<td name = "directions_ID" class = "topTitle"><?php echo @_PARENTDIRECTIONS; ?>
</td>
				<?php if (@G_VERSIONTYPE != 'enterprise'): ?> 				<td name = "price" class = "topTitle centerAlign"><?php echo @_PRICE; ?>
</td>
...
" class = "editLink"><?php echo $this->_tpl_vars['lesson']['name']; ?>
				...
				<td><?php echo $this->_tpl_vars['T_DIRECTION_PATHS'][$this->_tpl_vars['lesson']['directions_ID']]; ?>
</td>
				<?php if (@G_VERSIONTYPE != 'enterprise'): ?> 				<td class = "centerAlign"><?php if ($this->_tpl_vars['course']['price'] == 0): ?><?php echo @_FREECOURSE; ?>
...
" ><?php echo @_NEWGROUP; ?>
				...
				<?php if (@G_VERSIONTYPE == 'enterprise'): ?> 				<span>
					<img src = "images/16x16/search.png" title = "<?php echo @_SEARCHGROUPUSERS; ?>
" alt = "<?php echo @_SEARCHGROUPUSERS; ?>
">
										<a href = "administrator.php?ctg=search_users" title = "<?php echo @_SEARCHGROUPUSERS; ?>
" ><?php echo @_SEARCHGROUPUSERS; ?>
</a>
...
?ctg=user_groups&">
				<tr class = "topTitle">
					<td class = "topTitle" name = "name"><?php echo @_GROUPNAME; ?>
</td>
...
" <?php if (! $this->_tpl_vars['group']['active']): ?>style="color:red"<?php endif; ?>>
							<?php if (@G_VERSIONTYPE != 'community'): ?>							<?php echo $this->_tpl_vars['group']['name']; ?>
<?php if (isset ( $this->_tpl_vars['group']['is_default'] ) && $this->_tpl_vars['group']['is_default'] == '1'): ?>&nbsp;<i>(<?php echo @_DEFAULT; ?>
)</i><?php endif; ?>
							<?php else: ?>							<?php echo $this->_tpl_vars['group']['name']; ?>
