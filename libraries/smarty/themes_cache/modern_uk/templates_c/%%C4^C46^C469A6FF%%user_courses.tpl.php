<?php /* Smarty version 2.6.27, created on 2014-09-15 14:00:18
...
<?php ob_start(); ?>
    <tr class = "topTitle">
		<td class = "topTitle" 	name = "name" style = "width:30%"><?php echo @_COURSENAME; ?>
</td>
<?php if (@G_VERSIONTYPE == 'enterprise'): ?> 		<td class = "topTitle"  name = "location" style = "width:15%"><?php echo @_LOCATION; ?>
</td>
<?php endif; ?> 		<td class = "topTitle"  name = "directions_ID" style = "width:15%"><?php echo @_PARENTDIRECTIONS; ?>
</td>
...
<?php if (@G_VERSIONTYPE == 'enterprise'): ?> 			<td><?php echo $this->_tpl_vars['course']['location']; ?>
</td>
<?php endif; ?> 	        <td><?php echo $this->_tpl_vars['T_DIRECTION_PATHS'][$this->_tpl_vars['course']['directions_ID']]; ?>
</td>
	        <td class = "centerAlign">
