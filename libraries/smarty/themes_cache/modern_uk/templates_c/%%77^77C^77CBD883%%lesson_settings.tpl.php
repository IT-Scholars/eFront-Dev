<?php /* Smarty version 2.6.27, created on 2014-09-15 16:53:13
         compiled from includes/lesson_settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'eF_template_printBlock', 'includes/lesson_settings.tpl', 18, false),array('function', 'cycle', 'includes/lesson_settings.tpl', 81, false),array('modifier', 'eF_template_isOptionVisible', 'includes/lesson_settings.tpl', 151, false),array('modifier', 'replace', 'includes/lesson_settings.tpl', 280, false),array('modifier', 'cat', 'includes/lesson_settings.tpl', 281, false),)), $this); ?>
...
?<?php if ($_SESSION['s_type'] == 'administrator'): ?>ctg=personal&user=<?php echo $this->_tpl_vars['user']['login']; ?>
&op=evaluations<?php else: ?>ctg=evaluations&user=<?php echo $this->_tpl_vars['user']['login']; ?>
<?php endif; ?>">
                                                                    <img src="images/16x16/search.png" title="<?php echo @_SHOWEVALUATIONS; ?>
" alt="<?php echo @_SHOWEVALUATIONS; ?>
"/ border="0"></a>
                                                            <?php endif; ?>                                                             <?php if ($this->_tpl_vars['user']['basic_user_type'] == 'student'): ?>
...
">
					...
					<?php endif; ?>
                    <?php if (((is_array($_tmp='news')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
						<?php ob_start(); ?>
...
">
					...
					<?php endif; ?>
					<?php if (((is_array($_tmp='calendar')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
                    <?php ob_start(); ?>
...
">
                    ...
                    <?php if (( @G_VERSIONTYPE != 'community' )): ?> 							<?php if ($this->_tpl_vars['T_CONFIGURATION']['social_modules_activated'] == 1): ?>
	                    <?php ob_start(); ?>
	                        <li id = "layoutsecondlist_moduleTimeline">
	                            <table class = "innerTable" style = "width:300px">
	                                <tr class = "handle">
	                                    <th class = "innerTableHeader">
	                                        <img class = "iconTableImage" src = "images/32x32/users.png" alt = "<?php echo @_LESSONPEOPLE; ?>
" title = "<?php echo @_LESSONPEOPLE; ?>
">
	                                        <?php echo @_LESSONPEOPLE; ?>

	                                    </th>
	                                    <td class = "innerTableHeader" style = "text-align:right"><img src = "images/16x16/<?php if (isset ( $this->_tpl_vars['T_DEFAULT_POSITIONS']['visibility']['moduleTimeline'] ) && $this->_tpl_vars['T_DEFAULT_POSITIONS']['visibility']['moduleTimeline'] == 0): ?>navigate_down.png<?php else: ?>navigate_up.png<?php endif; ?>" onclick = "toggleVisibility(Element.extend(this).up().up().next().down(), this);"></td></tr>

	                                <tr><td colspan = "2" style = "height:60px;text-align:center;vertical-align:top;<?php if (isset ( $this->_tpl_vars['T_DEFAULT_POSITIONS']['visibility']['moduleTimeline'] ) && $this->_tpl_vars['T_DEFAULT_POSITIONS']['visibility']['moduleTimeline'] == 0): ?>display:none;<?php endif; ?>"><img src = "images/others/lesson_people_thumbnail.png"></td></tr>
	                            </table>
	                        </li>
	                    <?php $this->_smarty_vars['capture']['layout_moduleTimeline'] = ob_get_contents(); ob_end_clean(); ?>
	                    <?php endif; ?>
                    <?php endif; ?>                 <?php $_from = $this->_tpl_vars['T_LESSON_MODULES']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['lesson_modules_list'] = array('total' => count($_from), 'iteration' => 0);
...
')" class = "flatButton"/></td></tr>
    ...
    <?php else: ?>
                <?php echo smarty_function_eF_template_printBlock(array('title' => (@_OPTIONSFORLESSON)."<span class = 'innerTableName'>&nbsp;&quot;".($this->_tpl_vars['T_CURRENT_LESSON']->lesson['name'])."&quot;</span>",'columns' => 4,'links' => $this->_tpl_vars['T_LESSON_SETTINGS'],'image' => '32x32/lessons.png','main_options' => $this->_tpl_vars['T_TABLE_OPTIONS'],'groups' => $this->_tpl_vars['T_LESSON_SETTINGS_GROUPS'],'help' => 'Administration','options' => $this->_tpl_vars['T_LESSON_OPTIONS']), $this);?>
