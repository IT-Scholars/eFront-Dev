...
<?php echo 'page.php?fb_authenticated=1\'; }'; ?>
				                                        	...
				                                        	<table width="100%"><tr><td class="emptyCategory"><?php echo @_YOUARENOTCONNECTEDTOFACEBOOK; ?>
 <a href="javascript:void(0);" onclick="return false;"><?php echo @_HERE; ?>
</a></td></tr></table>
							...
							<?php if (isset ( $this->_tpl_vars['T_FORUM_MESSAGES'] ) && ((is_array($_tmp='forum')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
								<?php ob_start(); ?>
			                                <tr><td class = "moduleCell">
			                                        <?php ob_start(); ?>
                            ...
                            <?php endif; ?>
							<?php if (isset ( $this->_tpl_vars['T_ALL_PROJECTS'] ) && ((is_array($_tmp='projects')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
								<?php ob_start(); ?>
			                                <tr><td class = "moduleCell">
			                                        <?php ob_start(); ?>
                            ...
                            <?php endif; ?>
                            <?php if ($this->_tpl_vars['T_NEWS'] && ((is_array($_tmp='news')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
								<?php ob_start(); ?>
			                                <tr><td class = "moduleCell">
			                                        <?php ob_start(); ?>
...
&lessons_ID=all&popup=1" target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, '<?php echo @_ANNOUNCEMENT; ?>
...
#"><?php echo $this->_tpl_vars['item']['time_since']; ?>
                            ...
                            <?php endif; ?>
                            <?php if ($this->_tpl_vars['T_LESSON_COMMENTS'] && ((is_array($_tmp='comments')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
								<?php ob_start(); ?>
			                                <tr><td class = "moduleCell">
			                                        <?php ob_start(); ?>
...
&popup=1" onclick = "eF_js_showDivPopup(event, '<?php echo @_USERPROFILE; ?>
...
" border = 0 style="vertical-align:middle" /> </a></td>
		                                        ...
		                                        <?php if (( @G_VERSIONTYPE != 'community' )): ?> 			                                        	<?php echo smarty_function_eF_template_printBlock(array('title' => @_MYWALL,'data' => $this->_smarty_vars['capture']['t_my_wall'],'image' => "32x32/billboard.png",'options' => $this->_tpl_vars['T_MY_INFO_OPTIONS']), $this);?>
...
<?php endif; ?></td>
										...
										<?php if (( @G_VERSIONTYPE != 'community' )): ?> 				                                    <?php if ($_SESSION['s_type'] == 'administrator'): ?>
			                                    <?php echo smarty_function_eF_template_printBlock(array('title' => @_PEOPLE,'data' => $this->_smarty_vars['capture']['t_relatedPeople'],'image' => "32x32/users.png",'options' => $this->_tpl_vars['T_MY_RELATED_PEOPLE_OPTIONS']), $this);?>

			                                    <?php else: ?>
			                                    <?php echo smarty_function_eF_template_printBlock(array('title' => @_USERSWITHCOMMONLESSONS,'data' => $this->_smarty_vars['capture']['t_relatedPeople'],'image' => "32x32/users.png",'options' => $this->_tpl_vars['T_MY_RELATED_PEOPLE_OPTIONS']), $this);?>
...
?>
 ...
 <span class="timeago"><?php echo $this->_tpl_vars['event']['time']; ?>
	                                        ...
	                                        <?php if (( @G_VERSIONTYPE != 'community' )): ?> 		                                        	<?php if ($this->_tpl_vars['T_CURRENT_USER']->coreAccess['social'] != 'hidden'): ?>
													<?php echo smarty_function_eF_template_printBlock(array('title' => @_SYSTEMTIMELINE,'data' => $this->_smarty_vars['capture']['t_timeline'],'image' => "32x32/social.png",'options' => $this->_tpl_vars['T_MY_TIMELINE_OPTIONS'],'help' => 'Social_extensions'), $this);?>
						    ...
						    <?php endforeach; endif; unset($_from); ?>
								...
								<?php ob_start(); ?>
                                        	<tr><td class = "moduleCell">
		                                        <?php ob_start(); ?>
<!--ajax:messagesTable-->
                                            <table class = "sortedTable" width = "100%" height="40px" size = "<?php echo $this->_tpl_vars['T_MESSAGES_SIZE']; ?>
" sortBy = "0" useAjax = "1" id = "messagesTable" rowsPerPage="10" limit="100" url="<?php echo $_SERVER['PHP_SELF']; ?>
...
">
	...
	<?php if (! in_array ( 'moduleCalendar' , $this->_tpl_vars['T_POSITIONS'] ) && $this->_smarty_vars['capture']['moduleCalendar']): ?>
	...
	<?php endif; ?>
	<?php if (! in_array ( 'moduleProjectsList' , $this->_tpl_vars['T_POSITIONS'] ) && $this->_smarty_vars['capture']['moduleProjectsList'] && ((is_array($_tmp='projects')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
	...
	<?php endif; ?>
	<?php if (! in_array ( 'moduleCommentsList' , $this->_tpl_vars['T_POSITIONS'] ) && $this->_smarty_vars['capture']['moduleCommentsList'] && ((is_array($_tmp='comments')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
...
<!--/ajax:lessonTimelineTable-->
						...
						<?php if (( @G_VERSIONTYPE != 'community' )): ?> 								<?php echo smarty_function_eF_template_printBlock(array('title' => @_LESSONSTIMELINE,'data' => $this->_smarty_vars['capture']['t_lessons_timeline_code'],'image' => '32x32/user_timeline.png'), $this);?>
...
<!--/ajax:systemTimelineTable-->
						...
						<?php if (( @G_VERSIONTYPE != 'community' )): ?> 								<?php if ($this->_tpl_vars['T_CURRENT_USER']->coreAccess['social'] != 'hidden'): ?>
								<?php echo smarty_function_eF_template_printBlock(array('title' => @_SYSTEMTIMELINE,'data' => $this->_smarty_vars['capture']['t_system_timeline_code'],'image' => '32x32/social.png'), $this);?>
