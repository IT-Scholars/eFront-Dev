...
<?php if ($this->_tpl_vars['total'] == 100): ?>+<?php endif; ?> <?php echo @_MORE; ?>
 ...
 <?php echo @_LESS; ?>
    ...
    <?php endif; ?>
        ...
        <?php if ($this->_tpl_vars['T_COMMENTS'] && ((is_array($_tmp='comments')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
        <?php ob_start(); ?>
			<tr><td class = "moduleCell">
                <?php ob_start(); ?>
...
" class = "handle"></a>
                        <span class = "leftOption"><?php echo $this->_tpl_vars['T_CURRENT_LESSON']->lesson['formatted_name']; ?>
</span>
...
">
	...
	<?php endif; ?>
	<?php if (! in_array ( 'moduleCalendar' , $this->_tpl_vars['T_POSITIONS'] ) && $this->_smarty_vars['capture']['moduleCalendar'] && ((is_array($_tmp='calendar')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
