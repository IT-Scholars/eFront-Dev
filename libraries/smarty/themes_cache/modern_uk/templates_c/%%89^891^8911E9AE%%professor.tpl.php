...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'professor.tpl', 8, false),array('modifier', 'cat', 'professor.tpl', 190, false),array('modifier', 'formatLogin', 'professor.tpl', 238, false),array('modifier', 'eF_truncate', 'professor.tpl', 289, false),array('modifier', 'eF_template_isOptionVisible', 'professor.tpl', 1043, false),array('function', 'cycle', 'professor.tpl', 908, false),array('function', 'eF_template_printBlock', 'professor.tpl', 934, false),array('function', 'eF_template_printMessageBlock', 'professor.tpl', 969, false),)), $this); ?>
...
<?php if ($_SESSION['s_lessons_ID']): ?>
	...
	<?php if ($this->_tpl_vars['T_NO_HORIZONTAL_MENU']): ?><?php $this->assign('title_onclick', "top.sideframe.hideAllLessonSpecific();"); ?><?php endif; ?>
		<?php $this->assign('title', "<a class = 'titleLink' title = '".(@_HOME)."' href = '".($this->_tpl_vars['T_HOME_LINK'])."' onclick = '".($this->_tpl_vars['title_onclick'])."'>".(@_HOME)."</a>"); ?>
		...
		<?php endif; ?>
<?php else: ?>
	<?php $this->assign('title', "<a class = 'titleLink' title = '".(@_HOME)."' href = '".($this->_tpl_vars['T_HOME_LINK'])."'>".(@_HOME)."</a>"); ?>
<?php endif; ?>
...
<?php if (@G_VERSIONTYPE == 'enterprise'): ?> 	var myform = "noform";
<?php endif; ?> 
<?php echo '
...
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'tincan' )): ?>
	<?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink'  href = '".($_SERVER['PHP_SELF'])."?ctg=tincan'>".(@_TINCAN)."</a>"); ?>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "includes/tincan.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
<?php if (( $this->_tpl_vars['T_CTG'] == 'statistics' )): ?>
	...
	<?php elseif ($_GET['option'] == 'branches'): ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics&option=branches">') : smarty_modifier_cat($_tmp, '?ctg=statistics&option=branches">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_BRANCHSTATISTICS) : smarty_modifier_cat($_tmp, @_BRANCHSTATISTICS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
		<?php if (isset ( $_GET['sel_branch'] )): ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics&option=branches&sel_branch=') : smarty_modifier_cat($_tmp, '?ctg=statistics&option=branches&sel_branch=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['sel_branch']) : smarty_modifier_cat($_tmp, $_GET['sel_branch'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">') : smarty_modifier_cat($_tmp, '">')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['T_BRANCH_INFO']['name']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['T_BRANCH_INFO']['name'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
		<?php endif; ?>
    <?php elseif ($_GET['option'] == 'tincan'): ?>
        <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics&option=tincan">') : smarty_modifier_cat($_tmp, '?ctg=statistics&option=tincan">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_TINCANREPORTS) : smarty_modifier_cat($_tmp, @_TINCANREPORTS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
...
<?php if (isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'users'): ?>
	...
	<?php if (! isset ( $_GET['print_preview'] ) && ! isset ( $_GET['print'] )): ?>
	<?php $this->assign('category', 'company'); ?>
	...
	<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=users">') : smarty_modifier_cat($_tmp, '?ctg=users">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_EMPLOYEES) : smarty_modifier_cat($_tmp, @_EMPLOYEES)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
	<?php endif; ?>

	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "hcd_users.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'emails' )): ?>
   <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp='<a class="titleLink" href ="')) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=emails">') : smarty_modifier_cat($_tmp, '?ctg=emails">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_EMAILS) : smarty_modifier_cat($_tmp, @_EMAILS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
   <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "emails.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'module_hcd' )): ?>
	...
	<?php if ($_GET['op'] == 'skills'): ?>
		...
		<?php if ($_GET['add_skill'] || $_GET['edit_skill']): ?>
				<?php if ($_GET['edit_skill'] != ""): ?>
					<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=module_hcd&op=skills&edit_skill=') : smarty_modifier_cat($_tmp, '?ctg=module_hcd&op=skills&edit_skill=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['edit_skill']) : smarty_modifier_cat($_tmp, $_GET['edit_skill'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">') : smarty_modifier_cat($_tmp, '">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_SKILLDATA) : smarty_modifier_cat($_tmp, @_SKILLDATA)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
				<?php else: ?>
					<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=module_hcd&op=skills&add_skill=1">') : smarty_modifier_cat($_tmp, '?ctg=module_hcd&op=skills&add_skill=1">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_SKILLDATA) : smarty_modifier_cat($_tmp, @_SKILLDATA)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
				<?php endif; ?>
		 <?php endif; ?>
	<?php endif; ?>
	...
	<?php if ($_GET['op'] == 'reports'): ?>
	   <?php if ($_SESSION['s_type'] == 'administrator'): ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp='<a class="titleLink" href ="')) ? $this->_run_mod_handler('cat', true, $_tmp, $_SESSION['s_type']) : smarty_modifier_cat($_tmp, $_SESSION['s_type'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '.php?ctg=statistics">') : smarty_modifier_cat($_tmp, '.php?ctg=statistics">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_STATISTICS) : smarty_modifier_cat($_tmp, @_STATISTICS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
	   ...
	   <?php else: ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp='<a class="titleLink" href ="')) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=control_panel">') : smarty_modifier_cat($_tmp, '?ctg=control_panel">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_HOME) : smarty_modifier_cat($_tmp, @_HOME)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class="titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class="titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=module_hcd">') : smarty_modifier_cat($_tmp, '?ctg=module_hcd">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_ORGANIZATION) : smarty_modifier_cat($_tmp, @_ORGANIZATION)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=module_hcd&op=reports">') : smarty_modifier_cat($_tmp, '?ctg=module_hcd&op=reports">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_SEARCHEMPLOYEE) : smarty_modifier_cat($_tmp, @_SEARCHEMPLOYEE)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
	   <?php endif; ?>
	<?php endif; ?>
...
<?php endif; ?>
<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'evaluations' )): ?>
		<?php ob_start(); ?>
		<?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href ='professor.php?ctg=settings'>".(@_OPTIONSFORLESSON)." &quot;".($this->_tpl_vars['T_CURRENT_LESSON']->lesson['name'])."&quot;</a>"); ?>
		<?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href ='".($_SERVER['PHP_SELF'])."?ctg=settings&op=lesson_users'>".(@_LESSONUSERS)."</a>"); ?>
		<?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class='titleLink' href ='".($_SERVER['PHP_SELF'])."?ctg=evaluations&user=".($_GET['user'])."'>".(@_EVALUATIONS)."</a>"); ?>
...
', 1)"><img src="images/16x16/add.png" title="<?php echo @_NEWEVALUATION; ?>
" alt="<?php echo @_NEWEVALUATION; ?>
" border="0" /></a></td>
					<td><a href = "<?php echo $_SERVER['PHP_SELF']; ?>
?ctg=personal&user=<?php echo $_GET['user']; ?>
&op=evaluations&add_evaluation=1&popup=1" target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, '<?php echo @_NEWEVALUATION; ?>
', 1)"><?php echo @_NEWEVALUATION; ?>
</a></td>
			   </tr>
		   </table>
			...
			<table border = "0" width = "100%" class = "sortedTable">
				<tr class = "topTitle">
					<td class = "topTitle" width = "35%"><?php echo @_DATE; ?>
</td>
					<td class = "topTitle"><?php echo @_SUBJECT; ?>
</td>
			...
			<?php if (isset ( $this->_tpl_vars['T_EVALUATION'] )): ?>
				<?php $_from = $this->_tpl_vars['T_EVALUATION']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['users_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['users_list']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['evaluation']):
        $this->_foreach['users_list']['iteration']++;
?>
				<tr class = "<?php echo smarty_function_cycle(array('values' => "oddRowColor, evenRowColor"), $this);?>
">
					<td>#filter:timestamp_time-<?php echo $this->_tpl_vars['evaluation']['timestamp']; ?>
#</td>
					<td><?php echo $this->_tpl_vars['evaluation']['specification']; ?>
</td>
					<td><?php echo $this->_tpl_vars['evaluation']['author']; ?>
</td>
					<td align = "center">
						<table>
							<tr>
...
.php?ctg=personal&user=<?php echo $_GET['user']; ?>
&op=evaluations&edit_evaluation=<?php echo $this->_tpl_vars['evaluation']['event_ID']; ?>
...
" /></a></td><td>
							...
							<td  width="45%">
								<a href = "<?php echo $_SESSION['s_type']; ?>
.php?ctg=personal&user=<?php echo $_GET['user']; ?>
&op=evaluations&delete_evaluation=<?php echo $this->_tpl_vars['evaluation']['event_ID']; ?>
" onclick = "return confirm('<?php echo @_AREYOUSUREYOUWANTTODELETEEVALUATION; ?>
...
" /></a>
			...
			<?php else: ?>
				<tr>
					<td colspan=4 class = "emptyCategory centerAlign"><?php echo @_NOEVALUATIONSASSIGNEDYET; ?>
</td>
				</tr>
			<?php endif; ?>

			</table>
		<?php $this->_smarty_vars['capture']['t_employee_evaluations_code'] = ob_get_contents(); ob_end_clean(); ?>
		<?php echo smarty_function_eF_template_printBlock(array('title' => ((is_array($_tmp=((is_array($_tmp=@_EVALUATIONOFEMPLOYEE)) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;') : smarty_modifier_cat($_tmp, '&nbsp;')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['user']) : smarty_modifier_cat($_tmp, $_GET['user'])),'data' => $this->_smarty_vars['capture']['t_employee_evaluations_code'],'image' => '32x32/catalog.png'), $this);?>

		<?php $this->_smarty_vars['capture']['moduleEvaluations'] = ob_get_contents(); ob_end_clean(); ?>
<?php endif; ?>
...
<?php endif; ?>
	...
	<table class = "centerTable">
		...
		<?php echo $this->_smarty_vars['capture']['moduleTincanOptions']; ?>
...
<?php ob_start(); ?>
	...
	<?php if ($_SESSION['s_lessons_ID'] != '' && ((is_array($_tmp='bookmarks')) ? $this->_run_mod_handler('eF_template_isOptionVisible', true, $_tmp) : smarty_modifier_eF_template_isOptionVisible($_tmp))): ?>
...
<?php if (@G_VERSIONTYPE == 'enterprise'): ?> <?php if (( $_GET['print'] == 1 )): ?>
	<?php if ($this->_tpl_vars['T_CTG'] == 'users'): ?>
		<?php echo '
		<script>
	...
	<?php elseif ($this->_tpl_vars['T_CTG'] == 'module_hcd' && $this->_tpl_vars['T_OP'] == 'chart'): ?>
		<?php echo '
		<script>
		printPartOfPage(\'singleColumn\');
		</script>
