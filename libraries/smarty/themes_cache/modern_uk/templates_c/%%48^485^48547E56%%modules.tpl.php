<?php /* Smarty version 2.6.27, created on 2014-09-16 16:09:11
         compiled from includes/modules.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'includes/modules.tpl', 26, false),array('function', 'eF_template_printBlock', 'includes/modules.tpl', 62, false),)), $this); ?>
        <?php ob_start(); ?>
...
?ctg=modules'; eF_js_showDivPopup(event, '<?php echo @_INSTALLMODULE; ?>
...
" onclick = "eF_js_showDivPopup(event, '<?php echo @_MODULEINFORMATION; ?>
...
'; eF_js_showDivPopup(event, '<?php echo @_UPGRADEMODULE; ?>
...
')"/>
									<?php endif; ?>
                                <?php endif; ?>
                                	<img class = "ajaxHandle" src = "images/16x16/export.png" title = "<?php echo @_EXPORT; ?>
" alt = "<?php echo @_EXPORT; ?>
" onclick = "exportModule(this, '<?php echo $this->_tpl_vars['T_MODULES'][$this->_sections['modules_list']['index']]['className']; ?>
')">
                                    </td>
                                </tr>
                            <?php endfor; else: ?>
