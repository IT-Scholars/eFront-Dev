...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'includes/lessons_list.tpl', 6, false),array('modifier', 'replace', 'includes/lessons_list.tpl', 172, false),array('function', 'eF_template_printBlock', 'includes/lessons_list.tpl', 37, false),)), $this); ?>
<script>
...
unset($_smarty_tpl_vars);
 ?>
					...
					<?php else: ?>
												<?php if ($this->_tpl_vars['T_DIRECTIONS_TREE']): ?>
						...
						<?php else: ?>
							...
							<?php $this->_smarty_vars['capture']['t_empty_catalog_code'] = ob_get_contents(); ob_end_clean(); ?>
							<?php echo smarty_function_eF_template_printBlock(array('title' => @_COURSECATALOG,'data' => $this->_smarty_vars['capture']['t_empty_catalog_code'],'image' => '32x32/catalog.png'), $this);?>
