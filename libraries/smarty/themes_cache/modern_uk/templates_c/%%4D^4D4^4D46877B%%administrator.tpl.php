...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'administrator.tpl', 28, false),array('modifier', 'formatLogin', 'administrator.tpl', 122, false),array('function', 'eF_template_printBlock', 'administrator.tpl', 248, false),array('function', 'eF_template_printMessageBlock', 'administrator.tpl', 620, false),)), $this); ?>
...
<?php if (( isset ( $this->_tpl_vars['T_CATEGORY'] ) && $this->_tpl_vars['T_CATEGORY'] == 'statistics' )): ?>
	...
	<?php elseif ($_GET['option'] == 'groups'): ?>
		...
		<?php endif; ?>
	<?php elseif ($_GET['option'] == 'skill'): ?>
        <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics&option=skill">') : smarty_modifier_cat($_tmp, '?ctg=statistics&option=skill">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_SKILLSSTATISTICS) : smarty_modifier_cat($_tmp, @_SKILLSSTATISTICS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
		<?php if (isset ( $_GET['sel_skill'] )): ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics&option=skill&sel_skill=') : smarty_modifier_cat($_tmp, '?ctg=statistics&option=skill&sel_skill=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['sel_skill']) : smarty_modifier_cat($_tmp, $_GET['sel_skill'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">') : smarty_modifier_cat($_tmp, '">')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['T_CURRENT_SKILL_INFO']->skill['description']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['T_CURRENT_SKILL_INFO']->skill['description'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
		<?php endif; ?>
...
<?php if ($this->_tpl_vars['T_CTG'] == 'search_courses'): ?>
    ...
    <?php if (@G_VERSIONTYPE == 'enterprise'): ?>     <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=search_courses">') : smarty_modifier_cat($_tmp, '?ctg=search_courses">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_SEARCHCOURSEUSERS) : smarty_modifier_cat($_tmp, @_SEARCHCOURSEUSERS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
    <?php else: ?>     <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=search_courses">') : smarty_modifier_cat($_tmp, '?ctg=search_courses">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_SEARCHCOURSEUSERS) : smarty_modifier_cat($_tmp, @_SEARCHCOURSEUSERS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
    <?php endif; ?> 
        <?php ob_start(); ?>
                            <tr><td class = "moduleCell">
                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
                                <?php if (@G_VERSIONTYPE == 'enterprise'): ?>                                     <?php echo smarty_function_eF_template_printBlock(array('title' => @_FINDEMPLOYEES,'data' => $this->_smarty_vars['capture']['t_search_course_code'],'image' => '32x32/scorm.png','main_options' => $this->_tpl_vars['T_TABLE_OPTIONS']), $this);?>

                                    <br />
                                    <?php echo smarty_function_eF_template_printBlock(array('title' => @_EMPLOYEESFULFILLINGCRITERIA,'data' => $this->_smarty_vars['capture']['t_found_employees_code'],'image' => '32x32/user.png','options' => $this->_tpl_vars['T_SENDALLMAIL_LINK']), $this);?>

                                <?php else: ?>                                     <?php echo smarty_function_eF_template_printBlock(array('title' => @_FINDEMPLOYEES,'data' => $this->_smarty_vars['capture']['t_search_course_code'],'image' => '32x32/scorm.png','main_options' => $this->_tpl_vars['T_TABLE_OPTIONS']), $this);?>
...
<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['T_CTG'] == 'search_users'): ?>
	    <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp='<a class="titleLink" href ="')) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=control_panel">') : smarty_modifier_cat($_tmp, '?ctg=control_panel">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_HOME) : smarty_modifier_cat($_tmp, @_HOME)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
	    <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=search_users">') : smarty_modifier_cat($_tmp, '?ctg=search_users">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_SEARCHFORUSER) : smarty_modifier_cat($_tmp, @_SEARCHFORUSER)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
	    	    <?php ob_start(); ?>
	    							                            <tr><td class = "moduleCell">
	                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "includes/search_users.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	                            </td></tr>
