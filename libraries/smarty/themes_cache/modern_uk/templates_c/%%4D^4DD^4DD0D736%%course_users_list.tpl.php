<?php /* Smarty version 2.6.27, created on 2014-09-22 19:20:14
         compiled from includes/common/course_users_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'includes/common/course_users_list.tpl', 44, false),array('modifier', 'str_replace', 'includes/common/course_users_list.tpl', 96, false),array('modifier', 'formatLogin', 'includes/common/course_users_list.tpl', 175, false),array('modifier', 'sizeof', 'includes/common/course_users_list.tpl', 202, false),array('modifier', 'eF_template_isOptionVisible', 'includes/common/course_users_list.tpl', 223, false),)), $this); ?>
<?php ob_start(); ?>
<style>
<?php echo '
...
<?php if (@G_VERSIONTYPE != 'community'): ?> 		<?php if (in_array ( 'issued_certificate' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?><td class = "topTitle issued_certificate noSort" name = "issued_certificate"><?php echo @_CERTIFICATEKEY; ?>
</td><?php endif; ?>
		<?php if (@G_VERSIONTYPE != 'standard'): ?> 			<?php if (in_array ( 'expire_certificate' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?><td class = "topTitle expire_certificate noSort" name = "expire_certificate"><?php echo @_CERTIFICATEEXPIRESON; ?>
</td><?php endif; ?>
		<?php endif; ?> <?php endif; ?> <?php if (in_array ( 'operations' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?>		<td class = "topTitle operations noSort"><?php echo @_OPERATIONS; ?>
</td><?php endif; ?>
...
<?php endif; ?>
<?php if (@G_VERSIONTYPE != 'community'): ?> 	<?php if (in_array ( 'issued_certificate' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?>
			<td class = "centerAlign issued_certificate"><?php if ($this->_tpl_vars['user']['has_course']): ?><span id = "<?php echo $this->_tpl_vars['user']['login']; ?>
_certificate_key_span"><?php echo $this->_tpl_vars['user']['serial_number']; ?>
</span><input id="<?php echo $this->_tpl_vars['user']['login']; ?>
_certificate_key" type = "text" style = "display:none" value = "<?php echo $this->_tpl_vars['user']['serial_number']; ?>
" size = "38" /><?php if ($this->_tpl_vars['user']['issued_certificate'] != ''): ?><img class = "handle" src = "images/16x16/edit.png" title = "<?php echo @_EDIT; ?>
" alt = "<?php echo @_EDIT; ?>
" onClick = "$('<?php echo $this->_tpl_vars['user']['login']; ?>
_certificate_key').show();$('<?php echo $this->_tpl_vars['user']['login']; ?>
_certificate_key_span').hide(); $('<?php echo $this->_tpl_vars['user']['login']; ?>
_certificate_key_save').show()"><?php endif; ?><img id = "<?php echo $this->_tpl_vars['user']['login']; ?>
_certificate_key_save" style = "display:none" class = "handle" src = "images/16x16/success.png" title = "<?php echo @_SAVE; ?>
" alt = "<?php echo @_SAVE; ?>
" onClick = "updateCertificateKey(this, '<?php echo $this->_tpl_vars['user']['login']; ?>
');"><?php endif; ?></td>
	<?php endif; ?>
	<?php if (@G_VERSIONTYPE != 'standard'): ?> 		<?php if (in_array ( 'expire_certificate' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?>
				<td class = "expire_certificate"><?php if ($this->_tpl_vars['user']['has_course']): ?><span style="display:none"><?php echo $this->_tpl_vars['user']['expire_certificateTimestamp']; ?>
</span>#filter:timestamp-<?php echo $this->_tpl_vars['user']['expire_certificate']; ?>
#<?php endif; ?></td>
		<?php endif; ?>
	<?php endif; ?> 	
<?php endif; ?> <?php if (in_array ( 'operations' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?>
			<td class = "operations"><?php echo ''; ?><?php if (! isset ( $this->_tpl_vars['T_DATASOURCE_OPERATIONS'] ) || in_array ( 'statistics' , $this->_tpl_vars['T_DATASOURCE_OPERATIONS'] )): ?><?php echo ''; ?><?php if (! isset ( $this->_tpl_vars['T_CURRENT_USER']->coreAccess['statistics'] ) || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['statistics'] != 'hidden'): ?><?php echo '<a href="'; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo '?ctg=statistics&option=user&sel_user='; ?><?php echo $this->_tpl_vars['user']['login']; ?><?php echo '"><img class = "handle" src = "images/16x16/reports.png" title = "'; ?><?php echo @_STATISTICS; ?><?php echo '" alt = "'; ?><?php echo @_STATISTICS; ?><?php echo '" /></a>&nbsp;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (! isset ( $this->_tpl_vars['T_DATASOURCE_OPERATIONS'] ) || in_array ( 'certificate' , $this->_tpl_vars['T_DATASOURCE_OPERATIONS'] )): ?><?php echo ''; ?><?php if (@G_VERSIONTYPE != 'community'): ?><?php echo ' '; ?><?php echo ''; ?><?php if (( ! isset ( $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] ) || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' )): ?><?php echo ''; ?><?php if ($this->_tpl_vars['user']['issued_certificate']): ?><?php echo '<a href = "'; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo '?'; ?><?php echo $this->_tpl_vars['T_BASE_URL']; ?><?php echo '&op=course_certificates&export='; ?><?php echo $this->_tpl_vars['certificate_export_method']; ?><?php echo '&user='; ?><?php echo $this->_tpl_vars['user']['login']; ?><?php echo '&course='; ?><?php echo $_GET['course']; ?><?php echo '" target="_blank" title = "'; ?><?php echo @_VIEWCERTIFICATE; ?><?php echo '"><img src = "images/16x16/certificate.png" title = "'; ?><?php echo @_VIEWCERTIFICATE; ?><?php echo '" alt = "'; ?><?php echo @_VIEWCERTIFICATE; ?><?php echo '" border = "0"/></a>&nbsp;<a href = "'; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo '?'; ?><?php echo $this->_tpl_vars['T_BASE_URL']; ?><?php echo '&op=course_certificates&revoke_certificate='; ?><?php echo $this->_tpl_vars['user']['login']; ?><?php echo '" title = "'; ?><?php echo @_REVOKECERTIFICATE; ?><?php echo '"><img src = "images/16x16/error_delete.png" title = "'; ?><?php echo @_REVOKECERTIFICATE; ?><?php echo '" alt = "'; ?><?php echo @_REVOKECERTIFICATE; ?><?php echo '" border = "0"/></a>&nbsp;'; ?><?php if ($this->_tpl_vars['user']['completed']): ?><?php echo '<a href = "'; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo '?'; ?><?php echo $this->_tpl_vars['T_BASE_URL']; ?><?php echo '&op=course_certificates&reset_keep='; ?><?php echo $this->_tpl_vars['user']['login']; ?><?php echo '" title = "'; ?><?php echo @_RESETPROGRESSDATAKEEPCERTIFICATE; ?><?php echo '"><img src = "images/16x16/refresh.png" title = "'; ?><?php echo @_RESETPROGRESSDATAKEEPCERTIFICATE; ?><?php echo '" alt = "'; ?><?php echo @_RESETPROGRESSDATAKEEPCERTIFICATE; ?><?php echo '" border = "0"/></a>&nbsp;'; ?><?php endif; ?><?php echo ''; ?><?php elseif ($this->_tpl_vars['user']['completed']): ?><?php echo '<a href = "'; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo '?'; ?><?php echo $this->_tpl_vars['T_BASE_URL']; ?><?php echo '&op=course_certificates&issue_certificate='; ?><?php echo $this->_tpl_vars['user']['login']; ?><?php echo '&popup=1" title = "'; ?><?php echo @_ISSUECERTIFICATE; ?><?php echo '"><img src = "images/16x16/certificate.png" title = "'; ?><?php echo @_ISSUECERTIFICATE; ?><?php echo '" alt = "'; ?><?php echo @_ISSUECERTIFICATE; ?><?php echo '" border = "0"/></a>&nbsp;'; ?><?php else: ?><?php echo '<a href = "javascript:void(0)"><img class = "inactiveImage" src = "images/16x16/certificate.png" title = "'; ?><?php echo @_THEUSERHASNOTCOMPLETEDTHELESSON; ?><?php echo '" alt = "'; ?><?php echo @_THEUSERHASNOTCOMPLETEDTHELESSON; ?><?php echo '" />&nbsp;</a>'; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if ($this->_tpl_vars['user']['issued_certificate']): ?><?php echo '<a href = "'; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo '?'; ?><?php echo $this->_tpl_vars['T_BASE_URL']; ?><?php echo '&op=course_certificates&export='; ?><?php echo $this->_tpl_vars['certificate_export_method']; ?><?php echo '&user='; ?><?php echo $this->_tpl_vars['user']['login']; ?><?php echo '&course='; ?><?php echo $_GET['course']; ?><?php echo '" target="_blank" title = "'; ?><?php echo @_VIEWCERTIFICATE; ?><?php echo '"><img src = "images/16x16/certificate.png" title = "'; ?><?php echo @_VIEWCERTIFICATE; ?><?php echo '" alt = "'; ?><?php echo @_VIEWCERTIFICATE; ?><?php echo '" border = "0"/></a>&nbsp;'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ' '; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (! isset ( $this->_tpl_vars['T_DATASOURCE_OPERATIONS'] ) || in_array ( 'progress' , $this->_tpl_vars['T_DATASOURCE_OPERATIONS'] )): ?><?php echo ''; ?><?php if (( ! isset ( $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] ) || $this->_tpl_vars['T_CURRENT_USER']->coreAccess['course_settings'] == 'change' )): ?><?php echo '<a href = "'; ?><?php echo $_SERVER['PHP_SELF']; ?><?php echo '?'; ?><?php echo $this->_tpl_vars['T_BASE_URL']; ?><?php echo '&op=course_certificates&edit_user='; ?><?php echo $this->_tpl_vars['user']['login']; ?><?php echo '&popup=1" target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, \''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['login'])) ? $this->_run_mod_handler('formatLogin', true, $_tmp) : formatLogin($_tmp)); ?><?php echo '\', 2)" title = "'; ?><?php echo @_VIEWUSERLESSONPROGRESS; ?><?php echo '"><img src = "images/16x16/users.png" title = "'; ?><?php echo @_VIEWUSERCOURSEPROGRESS; ?><?php echo '" alt = "'; ?><?php echo @_VIEWUSERCOURSEPROGRESS; ?><?php echo '"/></a>'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>
</td>
<?php endif; ?>
...
<?php if (in_array ( 'project_status' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?>	<td class = "topTitle project_status"   name = "project_status"><?php echo @_PROJECTSSCORE; ?>
		...
		<?php endif; ?>
<?php if (in_array ( 'active_in_lesson' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?> <td class = "topTitle active_in_lesson" name = "active_in_lesson"><?php echo @_ENROLLEDON; ?>
</td><?php endif; ?>
...
<td class = "active_in_lesson">#filter:timestamp_time-<?php echo $this->_tpl_vars['user']['active_in_lesson']; ?>
#</td>
<?php endif; ?>			
<?php if (in_array ( 'completed' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?>
			<td class = "completed">
