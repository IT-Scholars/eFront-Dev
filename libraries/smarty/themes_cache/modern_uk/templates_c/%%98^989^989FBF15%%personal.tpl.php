<?php /* Smarty version 2.6.27, created on 2014-09-15 13:53:26
...
#&nbsp;</span>
				<?php if (( @G_VERSIONTYPE != 'community' )): ?> 							<span id = "statusText" onclick="javascript:showStatusChange()">
							<i><?php if ($this->_tpl_vars['T_USER_STATUS']): ?>"<?php echo $this->_tpl_vars['T_USER_STATUS']; ?>
"<?php else: ?>...<?php echo @_WRITESOMETHINGABOUTYOURSELF; ?>
<?php endif; ?></i>
						</span>
						<input class="inputText" id="inputStatusText" style="display:none;" value="<?php if ($this->_tpl_vars['T_USER_STATUS']): ?><?php echo $this->_tpl_vars['T_USER_STATUS']; ?>
<?php endif; ?>" onBlur="changeStatus()" />
						<img class = "ajaxHandle" id = "statusTextProgressImg" src = "images/32x32/edit.png" alt = "<?php echo @_CLICKTOCHANGESTATUS; ?>
" title = "<?php echo @_CLICKTOCHANGESTATUS; ?>
" onclick="javascript:showStatusChange()">
				<?php endif; ?> 						</td>
					</tr>
				</table>
...
unset($_smarty_tpl_vars);
 ?></div>
	...
	<?php elseif ($this->_tpl_vars['T_OP'] == 'placements' || $this->_tpl_vars['T_OP'] == 'history' || $this->_tpl_vars['T_OP'] == 'skills' || $this->_tpl_vars['T_OP'] == 'evaluations' || $this->_tpl_vars['T_OP'] == 'org_form' || $this->_tpl_vars['T_OP'] == 'quals'): ?>
		<div class = "tabber">
