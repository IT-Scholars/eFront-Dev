<?php /* Smarty version 2.6.27, created on 2014-09-17 13:34:34
...
" class = "editLink"><?php echo $this->_tpl_vars['course']['name']; ?>
</a></td>
...
" ><?php echo @_NEWDIRECTION; ?>
			...
			<?php endif; ?>
				<table border = "0" width = "100%"  class = "sortedTable" sortBy = "0">
					<tr class = "topTitle">
						<td class = "topTitle" name = "name"><?php echo @_DIRECTIONNAME; ?>
</td>
