<?php /* Smarty version 2.6.27, created on 2014-09-16 22:16:58
         compiled from includes/forum.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'eF_template_printBlock', 'includes/forum.tpl', 45, false),array('function', 'cycle', 'includes/forum.tpl', 216, false),array('modifier', 'addslashes', 'includes/forum.tpl', 230, false),array('modifier', 'eF_truncate', 'includes/forum.tpl', 408, false),)), $this); ?>
...
&popup=1" onclick = "eF_js_showDivPopup(event, '<?php echo @_NEWMESSAGE; ?>
...
&popup=1" target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, '<?php echo @_REPLY; ?>
...
?ctg=forum&add=1&type=message&topic_id=<?php echo $_GET['topic']; ?>
&replyto=<?php echo $this->_tpl_vars['T_POSTS'][$this->_sections['messages_list']['index']]['id']; ?>
&quote=1&popup=1"  target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, '<?php echo @_REPLYWITHQUOTE; ?>
...
&popup=1" target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, '<?php echo @_EDIT; ?>
...
" onclick = "if (confirm('<?php echo @_AREYOUSUREYOUWNATTODELETEMESSAGE; ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['T_POSTS'][$this->_sections['messages_list']['index']]['title'])) ? $this->_run_mod_handler('addslashes', true, $_tmp) : addslashes($_tmp)); ?>
...
&popup=1" onclick = "eF_js_showDivPopup(event, '<?php echo @_NEWTOPIC; ?>
...
&popup=1" onclick = "eF_js_showDivPopup(event, '<?php echo @_NEWPOLL; ?>
...
"/ >
                        <a href = "<?php echo $_SERVER['PHP_SELF']; ?>
?ctg=forum&config=1&popup=1" onclick = "eF_js_showDivPopup(event, '<?php echo @_FORUMCONFIGURATIONPANEL; ?>
...
?>
	                	<?php if ($this->_tpl_vars['subforum']['parent_id'] == $this->_tpl_vars['T_FORUMS'][$this->_tpl_vars['current_forum']]['id'] && ( $this->_tpl_vars['subforum']['status'] != '3' || $_SESSION['s_type'] == 'administrator' )): ?>
...
">
	                                            <td>
													<img class = "ajaxHandle forumIcon" src = "images/32x32/forum.png" alt = "<?php echo @_FORUM; ?>
...
">
	                                            <td>
	                                            	<img class = "ajaxHandle forumIcon" src = "images/32x32/polls.png" alt = "<?php echo @_POLL; ?>
...
" sortBy = "2" order="asc" id = "topicsTable" useAjax = "1" rowsPerPage = "<?php echo @G_DEFAULT_TABLE_SIZE; ?>
...
">
	                                            <td>
	                                            	<img class = "ajaxHandle forumIcon" src = "images/32x32/message.png" alt = "<?php echo @_TOPIC; ?>
...
<!--ajax:forumsTable-->	            
	                <table style = "width:100%" class = "sortedTable" size = "<?php echo $this->_tpl_vars['T_TABLE_SIZE']; ?>
" sortBy = "2" order="desc" id = "forumsTable" useAjax = "1" rowsPerPage = "<?php echo @G_DEFAULT_TABLE_SIZE; ?>
" url = "<?php echo $_SERVER['PHP_SELF']; ?>
?ctg=forum&">
	                    <tr>
