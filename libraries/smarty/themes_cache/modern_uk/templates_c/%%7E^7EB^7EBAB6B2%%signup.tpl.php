<?php /* Smarty version 2.6.27, created on 2014-09-15 13:40:26
         compiled from includes/blocks/signup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'includes/blocks/signup.tpl', 23, false),)), $this); ?>
...
<center><font color="#FF0000" size=3><b>IMPORTANT:</b></font><font size=2> If you have previously participated in training with Kaseya University through IT Scholars,<br> <a href="http://university.kaseya.com/KaseyaUniversity/AccountSync.htm" target=_blank>CLICK HERE</a> to learn how to create and synchronize your accounts between the learning systems.</font></center>
    		...
    		<div class = "formRow">	    	    
        		<div class = "formLabel">			
                    ...
                    <div class = "explanation"  <?php if ($this->_tpl_vars['T_LDAP_USER']): ?>style = "display:none"<?php endif; ?>><?php echo @_ONLYUSEBUSINESSEMAIL; ?>
</div>
            	</div>
        		<div class = "formElement">
...
?>
        ...
        <?php endforeach; endif; unset($_from); ?>  
    		...
    		<div class = "formRow">	    
            	<div class = "formLabel">			
                    <div class = "header"><?php echo $this->_tpl_vars['T_PERSONAL_INFO_FORM']['timezone']['label']; ?>
</div>
                    <div class = "explanation"></div>
            	</div>
        		<div class = "formElement">
                	<div class = "field"><?php echo $this->_tpl_vars['T_PERSONAL_INFO_FORM']['timezone']['html']; ?>
</div>
            		<?php if ($this->_tpl_vars['T_PERSONAL_INFO_FORM']['timezone']['error']): ?><div class = "error"><?php echo $this->_tpl_vars['T_PERSONAL_INFO_FORM']['timezone']['error']; ?>
</div><?php endif; ?>
        	    </div>      		
        	</div>
            <!-- End Addition by Masoud Sadjadi -->
