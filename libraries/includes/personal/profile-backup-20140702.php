...
if ($form -> isSubmitted() && $form -> validate()) {
	try {
		...
		if (isset($_GET['add_user'])) {
			// Added by Masoud Sadjadi on June 23, 2014 to support vLab in eFront
			// Beging addition
			$username 		= $userProperties['login'];
			$password 		= $userProperties['password'];
			$email 			= $userProperties['email'];
			$firstname 		= $userProperties['name'];
			$lastname 		= $userProperties['surname'];
			$timezone 		= $userProperties['timezone'];
			$companyname 	= $userProperties['comments'];
	
			// $moodleURL = "http://localhost/moodle19";
			$moodleURL = "http://ita-portal.cis.fiu.edu";

			// auto register	
			$str = $moodleURL . "/mod/deva/embedded/auto-register.php?efront=1&username=$username&password=$password&email=$email&firstname=$firstname&lastname=$lastname&timezone=$timezone&companyname=$companyname";	
			// echo $str;
			...
			// auto enroll
			$courseid = 123;
			$str = $moodleURL . "/mod/deva/embedded/auto-enroll.php?username=$username&courseid=$courseid";	
			// echo $str;
			$payload = file_get_contents($str);
			// echo $payload;

			// auto login
			$str = $moodleURL . "/mod/deva/embedded/auto-login.php?username=$username";	
			// echo $str;
			$payload = file_get_contents($str);
			// echo $payload;
			...
			// auto start vLab
			$course = "Kaseya%207.0%20Fundamentals%20Workshop"; // "Kaseya 7.0 Fundamentals Workshop";
			$resourceType = "VIRTUAL%20LAB"; // "VIRTUAL LAB";
			$str = $moodleURL . "/mod/deva/embedded/auto-start.php?username=$username&course=$course&resourceType=$resourceType";
			// echo $str;
			$payload = file_get_contents($str);
			// echo $payload;
			// End addition by Masoud Sadjadi
